        ...
        >
          <div className="card-body">
                ...
                <Stars>
                  <span>
                    {starArray.map((el, idx) => {
                      return <IoIosStar key={idx} size="30" onClick={() => handleStarClick(el)} className={clicked[idx] && "yellowStar"} />;
                    })}
                  </span>
                </Stars>
              </div>
            ...
            <div className="d-flex flex-row-reverse">
              <div>
                <button type="button" className="btn btn-danger mx-1" onClick={onClose}>
                  닫기
                </button>
